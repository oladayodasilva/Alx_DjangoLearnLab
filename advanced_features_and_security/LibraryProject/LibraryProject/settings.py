...
SECRET_KEY = 'django-insecure-fs4d8#ximfw33v445*koj-4oe+8tscn()a31w=4(87$ozm5x@3'
...
# HTTP Strict Transport Security — force browsers to only use HTTPS
...
# Enable browser-based XSS protection
